...
@section('title', 'Data Umkm — Taman Kenangan')
@section('content')
            ...
            <div class="page-title">
                <div class="card card-absolute">
                    <div class="card-header bg-primary">
                        <h5 class="text-white">Data Umkm</h5>
                    </div>
                    <div class="card-body">
                        <p>Dibawah ini adalah data umkm yang telah anda tambahkan. Untuk mengubah data bisa dengan mengklik logo pensil atau menghapus dengan logo keranjang sampah. Untuk menambahkan data bisa diklik       
                            <a href="{{ url('/admin/umkm/create') }}">disini ⇾</a>
                        </p>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        @forelse ($items as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->email }}</td>
                                                <td> <code style="color:green;"> Terenkripsi </td>
                                                <td>{{ $item->no_hp }}</td>
                                                <td>
                                                    ...
                                                    <form action="{{ route('admin.umkm.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apa anda yakin menghapus data?')">
