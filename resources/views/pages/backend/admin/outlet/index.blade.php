        ...
        <div class="container-fluid">
            <div class="page-title">
                <div class="card card-absolute">
                    ...
                    <div class="card-body">
                        <p>Dibawah ini adalah data outlet yang telah anda tambahkan. Untuk mengubah data bisa dengan mengklik logo pensil atau menghapus dengan logo keranjang sampah. Untuk menambahkan data bisa diklik       
                            <a href="{{ url('/admin/outlet/create') }}">disini ⇾</a>
                        </p>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        @forelse ($items as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->users->name ?? 'Tidak tersedia'}}</td>
                                                <td>{{ $item->users->no_hp ?? 'Tidak tersedia' }}</td>
                                                <td> 
                                                    <a href="{{ route('admin.outlet.show', $item->id) }}" class="btn btn-sm bg-primary">
                                                          Lihat Kuliner
                                                    </a>                
                                                </td>
                                                <td>
                                                    ...
                                                    <form action="{{ route('admin.outlet.destroy', $item->id) }}"
