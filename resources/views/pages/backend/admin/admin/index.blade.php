...
@section('title', 'Data Admin — Taman Kenangan')
@section('content')
        ...
        <div class="container-fluid">
            <div class="page-title">
                <div class="card card-absolute">
                    ...
                    <div class="card-body">
                        <p>Dibawah ini adalah data admin yang telah anda tambahkan. Untuk mengubah data bisa dengan mengklik logo pensil atau menghapus dengan logo keranjang sampah. Untuk menambahkan data bisa diklik       
                            <a href="{{ url('/admin/admin/create') }}">disini ⇾</a>
                        </p>
                    </div>
                </div>
            </div>
                                        ...
                                        @forelse ($items as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('admin.admin.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apa anda yakin menghapus data?')">
                                                        @csrf
                                                        @method('delete')
