...
@section('title', 'Data User — Taman Kenangan')
@section('content')
        ...
        <div class="container-fluid">
            <div class="page-title">
                <div class="card card-absolute">
                    ...
                    <div class="card-body">
                        <p>Dibawah ini adalah data user yang telah anda tambahkan. Untuk mengubah data bisa dengan mengklik logo pensil atau menghapus dengan logo keranjang sampah. Untuk menambahkan data bisa diklik       
                            <a href="{{ url('/admin/user/create') }}">disini ⇾</a>
                        </p>
                    </div>
                </div>
            </div>
                                        ...
                                        @forelse ($items as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('admin.user.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apa anda yakin menghapus data?')">
                                                        @csrf
                                                        @method('delete')
