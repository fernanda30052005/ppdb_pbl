...
@section('title','Edit Artikel — Taman Kenangan')
@section('content')
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        @endif
                        <form class="row" method="POST" action="{{route('admin.berita.update', $item->id)}}"
                                ...
                                <div class="email-wrapper">
                                    <div class="theme-form">
                                        <div class="form-group">
                                            ...
                                            <textarea id="text-box" name="konten" cols="10" rows="2">
