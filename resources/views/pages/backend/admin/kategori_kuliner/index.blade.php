        ...
        <div class="container-fluid">
            <div class="page-title">
                <div class="card card-absolute">
                    ...
                    <div class="card-body">
                        <p>Dibawah ini adalah data kategori kuliner yang telah anda tambahkan. Untuk mengubah data bisa dengan mengklik logo pensil atau menghapus dengan logo keranjang sampah. Untuk menambahkan data bisa diklik       
                            <a href="{{ url('/admin/kategori_kuliner/create') }}">disini ⇾</a>
                        </p>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        @forelse ($items as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.kategori_kuliner.edit', $item->id) }}"
                                                    ...
                                                    <form action="{{ route('admin.kategori_kuliner.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apa anda yakin menghapus data?')">
                                                        @csrf
                                                        @method('delete')
