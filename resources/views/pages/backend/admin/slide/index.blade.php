        ...
        <div class="page-title">
            <div class="card card-absolute mt-5 mt-md-4">
                <div class="card-header bg-primary">
                    <h5 class="text-white">Data Slide</h5>
                </div>
                <div class="card-body">
                    <p>Dibawah ini adalah data slide yang telah anda tambahkan. Untuk mengubah data bisa dengan mengklik logo pensil atau menghapus dengan logo keranjang sampah. Untuk menambahkan data bisa diklik       
                        <a href="{{ url('/admin/slide/create') }}">disini ⇾</a>
                    </p>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    @forelse ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->image)
                                                    <a href="{{ asset('storage/images/' . $item->image) }}" target="_blank">
                                                        <img src="{{ asset('storage/images/' . $item->image) }}" alt="image" class="img-thumbnail">
                                                    </a>
                                                @else
                                                    No image available
                                                @endif
                                                ...
                                                <form action="{{ route('admin.slide.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apa anda yakin menghapus data?')">
