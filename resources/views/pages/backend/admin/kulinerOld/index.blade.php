        ...
        <div class="container-fluid">
            <div class="page-title">
                <div class="card card-absolute">
                    ...
                    <div class="card-body">
                        <p>Dibawah ini adalah data Kuliner yang telah anda tambahkan. Data dibawah juga bisa anda
                                                ...
                                                <td>
                                                    @if ($item->foto)
                                                        <a href="{{ asset('storage/images/' . $item->foto) }}" target="_blank">
                                                            <img src="{{ asset('storage/images/' . $item->foto) }}" alt="image" class="img-thumbnail">
                                                        </a>
                                                    @else
                                                        No image available
                                                    @endif
