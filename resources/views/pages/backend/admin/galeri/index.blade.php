...
@section('title', 'Galeri Foto — Taman Kenangan')
@section('content')
                    ...
                    <div class="card-body">
                        <p>
                            Dibawah ini adalah foto yang telah kamu upload. <span class="d-none d-md-inline">
                                ...
                                tambah
                                fotomu
                                <a href="{{ route('admin.galeri.create')}}">disini ⇾</a>
                            </span>
                        </p>
                    </div>
                </div>
                        ...
                        <div class="gallery my-gallery card-body row" itemscope="">
                            @forelse ($items as $item)
                                <figure class="col-xl-3 col-md-4 col-6" itemprop="associatedMedia" itemscope=""><a
                                        href="{{ url('storage/images/galeri/' . $item->foto) }}" itemprop="contentUrl"
                                        data-size="1600x950"><img class="img-thumbnail"
                                            src="{{ url('storage/images/galeri/' . $item->foto) }}" itemprop="thumbnail"
                                            alt="Image description"></a>
                                    <figcaption itemprop="caption description">
                                        <a href="{{ url('storage/images/galeri/' . $item->foto) }}"
                                        ...
                                        <a download href="{{ url('storage/images/galeri/' . $item->foto) }}"
                                        ...
                                        <form action="{{ route('admin.galeri.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apa anda yakin menghapus data?')">
    ...
    @push('galleries-scripts')
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                var activeElement = document.querySelector("#sidebar-menu .active");
                if (activeElement) {
