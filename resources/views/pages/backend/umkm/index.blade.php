        ...
        <div class="container-fluid">
            <div class="row" style="margin-top:14vh">                
                ...
                <div class="col-sm-6 col-xl-3 col-lg-6">
                    <a href="/umkm/kuliner" class="card-link">
                    <div class="card o-hidden">
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                <div class="align-self-center text-center"><i data-feather="coffee"></i></div>
                                <div class="media-body"><span class="m-0">Total Kuliner</span>
                                    <h4 class="mb-0 counter">{{ $kulinerCount}}</h4>
                                    <i class="icon-bg"
                                        data-feather="coffee"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="splide__track">
                            <ul class="splide__list">
                                <li class="splide__slide">
                                    <img src="{{ url('images/splide/dashboardumkm.png') }}" class="d-block w-100"
