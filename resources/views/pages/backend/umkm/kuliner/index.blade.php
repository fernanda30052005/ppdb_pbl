...
@section('title', 'Data Kuliner — Taman Kenangan')
@section('content')
            ...
            <div class="page-title">
                <div class="card card-absolute">
                    <div class="card-header bg-primary">
                        <h5 class="text-white">Data Kuliner</h5>
                    </div>
                    <div class="card-body">
                        <p>Dibawah ini adalah data kuliner yang telah anda tambahkan. Untuk mengubah data bisa dengan mengklik logo pensil atau menghapus dengan logo keranjang sampah. Untuk menambahkan data bisa diklik       
                            <a href="{{ url('/umkm/kuliner/create') }}">disini ⇾</a>
                        </p>
                    </div>
                </div>
            </div>
                                ...
                                <table class="display" id="auto-fill">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <div class="font-weight-bold">{{ $item->nama }}</div> </td>
                                            <td>{{ $item->deskripsi }}</td>
                                            <td>{{ $item->kategori_kuliner->nama ?? 'Tidak ada Kategori' }}</td>
                                            <td>{{ $item->harga }}</td>
                                            <td>
                                                @if ($item->foto)
                                                    <a href="{{ asset('storage/images/' . $item->foto) }}" target="_blank">
                                                        <img src="{{ asset('storage/images/' . $item->foto) }}" alt="image" class="img-thumbnail" style="width: 100px; height: auto;">
                                                    </a>
                                                @else
                                                    No image available
                                                @endif
                                            ...
                                            <td>
                                                <a href="{{ route('umkm.kuliner.edit', $item->id) }}"
                                                ...
                                                <form action="{{ route('umkm.kuliner.destroy', $item->id) }}"
