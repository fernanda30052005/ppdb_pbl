...
<head>
    ...
    <title>Masuk Aplikasi - Taman Kenangan</title>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-7">
                <img class="bg-img-cover bg-center" src="{{ url('images/splide/taman1.jpg') }}"
                    alt="looginpage">
            </div>
            <div class="col-xl-5 p-0">
            {{-- <div class="col-xl-5 p-0 mx-auto"> --}}
                <div class="login-card">
                    <div class="login-main col-10 col-md-10">
                        <form class="theme-form" method="POST" action="{{ route('login.create') }}">
                            @csrf
                            @method('GET')

                            <h4>Masuk menggunakan akun yang terdaftar</h4>
                        ...
                        @endif
                            ...
                            <p class="mt-4 mb-0">Belum mempunyai akun?<a class="ml-2" href="{{ route('register.index') }}">Buat
                                sekarang </a></p>
                        </form>
                    </div>
