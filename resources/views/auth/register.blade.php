...
<head>
    ...
    <title>Daftar Akun Pengguna - Taman Kenangan</title>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-7">
                <img class="bg-img-cover bg-center " src="{{ url('images/splide/taman2.jpg') }}"
                    alt="looginpage">
            </div>
            <div class="col-xl-5 p-0">
                <div class="login-card">
                    <div class="login-main col-10 col-md-10">
                        <form method="POST" action={{route('register.store')}} class="theme-form">
                            @csrf
                            <h4>Daftarkan akun pengguna baru</h4>
